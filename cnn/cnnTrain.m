...
images = loadMNISTImages(fullfile(pwd, '..', 'common', 'train-images-idx3-ubyte'));
images = reshape(images,imageDim,imageDim,[]);
labels = loadMNISTLabels(fullfile(pwd, '..', 'common', 'train-labels-idx1-ubyte'));
...
testImages = loadMNISTImages(fullfile(pwd, '..', 'common', 't10k-images-idx3-ubyte'));
testImages = reshape(testImages,imageDim,imageDim,[]);
testLabels = loadMNISTLabels(fullfile(pwd, '..', 'common', 't10k-labels-idx1-ubyte'));

        ...
        case LBFGS % L-BFGS
			...
			if Damped
				...
				if i == 1
					...
					if useMex
                        % mex D:\Hoctap\MachineLearning\stanford_dl_ex-master\stanford_dl_ex-master\common\minFunc_2012\minFunc\mex\lbfgsProdC.c
        ...
        case NEWTON % Newton search direction
            ...
            if cgSolve == 0
                ...
                elseif HessianModify == 2
                    ...
                    if useMex
                        % mex D:\Hoctap\MachineLearning\stanford_dl_ex-master\stanford_dl_ex-master\common\minFunc_2012\minFunc\mex\mcholC.c
                        [L D perm] = mcholC(H);
                    else
                        [L D perm] = mchol(H);
                    end
                ...
                elseif cgSolve == 3
                    ...
                    g_old = g;
                    if useMex
                        % mex D:\Hoctap\MachineLearning\stanford_dl_ex-master\stanford_dl_ex-master\common\minFunc_2012\minFunc\mex\lbfgsC.c
                        precondFunc = @lbfgsC;
                    else
                        precondFunc = @lbfgs;
                    end
